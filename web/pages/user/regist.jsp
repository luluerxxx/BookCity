		...
		<script type="text/javascript">
			...
			$(function () {
				...
				$("#username").blur(function () {
					...
					$.getJSON("http://localhost:8099/bookcity1_war_exploded/userServlet","action=ajaxExistsUsername&username="+username,function (data){
...
<%--									<img alt="" src="static/img/code.bmp" style="float: right; margin-right: 40px">--%>
									<img alt="" src="kaptcha.jpg" id="code_img" style="width: 100px; height: 36px">
									<br />
									<br />
